...
class ALD_App(BaseMicroscopeApp):
    ...
    def setup(self):
        ...
        relay.settings['connected'] = False
        
        from ScopeFoundryHW.ALD.ALD_shutter.ALD_shutter import ALD_Shutter
        self.add_hardware(ALD_Shutter(self)).settings['connected'] = False
        ...
        self.add_hardware(LoveboxHW(self)).settings['connected'] = False
        
        from ScopeFoundryHW.ALD.MKS_146.mks_146_hw import MKS_146_Hardware
        self.add_hardware(MKS_146_Hardware(self)).settings['connected'] = False
         
        from ScopeFoundryHW.ALD.MKS_600.mks_600_hw import MKS_600_Hardware
        self.add_hardware(MKS_600_Hardware(self)).settings['connected'] = False
        
        from ScopeFoundryHW.ALD.pfeiffer_vgc.pfeiffer_vgc_hw import Pfeiffer_VGC_Hardware
        self.add_hardware(Pfeiffer_VGC_Hardware(self)).settings['connected'] = False
          
        from ScopeFoundryHW.ALD.Seren.seren_hw import Seren_HW
        self.add_hardware(Seren_HW(self)).settings['connected'] = False
        ...
        self.add_measurement(ALD_Display(self))#.start()
