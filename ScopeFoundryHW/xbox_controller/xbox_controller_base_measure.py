...
class XboxBaseMeasure(Measurement):
    ...
    def setup_figure(self):
        ...
        self.stage1.settings.x_position.connect_to_widget(self.ui.x_pos_doubleSpinBox)
        self.stage2.settings.y_position.connect_to_widget(self.ui.y_pos_doubleSpinBox)
...
#                             self.stage1.move_x(self.settings["jog_step_xy"] * val)
                            print('Axis' + str(i) + " = " + str(self.joystick.get_axis(i)))
                        elif i == 1 and abs(val) >= self.joy_threshold:
#                             self.stage1.move_y(self.settings["jog_step_xy"] * val)
                            print('Axis' + str(i) + " = " + str(self.joystick.get_axis(i)))
                        elif i == 3 and abs(val) >= self.joy_threshold:
#                             self.stage2.move_x(self.settings["jog_step_xy"] * val)
                            print('Axis' + str(i) + " = " + str(self.joystick.get_axis(i)))
                        elif i == 4 and abs(val) >= self.joy_threshold:
#                             self.stage2.move_y(self.settings["jog_step_xy"] * val)
                            print('Axis' + str(i) + " = " + str(self.joystick.get_axis(i)))
