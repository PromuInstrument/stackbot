...
class AutoFocusMeasure(Measurement):
    ...
    def setup(self):
        ...
        self.optimization_quantity_choices = [
                        ...
                        # TODO: MINIMAL
                         ...
                         ('andor(CONTINUOUSLY)_count_rate','measure/andor_ccd_readout/count_rate'),
                         ]
    ...
    def setup_figure(self):      
        ...
        settings_layout.addWidget( S.New_UI(['z_correction', 'use_fine_optimization']) )
    ...
    def run(self):
        ...
        if S['use_current_z_as_center']:
            S['z_center'] = z_position.read_from_hardware()
    ...
    def update_display(self):
        ...
        if hasattr(self, 'quantity_records_fine'):
