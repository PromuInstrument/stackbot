...
class TcReaderStreamHW(HardwareComponent):
    """
    using a NI 9211 CDAQ TC reader
    Configured as K-type thermocouple reader
    in streaming (callback) mode
    """
    
    name = 'tc_reader_stream'
    ...
    def connect(self):
        ...
        # Set continuous scanning at 7Hz
        self.task.CfgSampClkTiming("", 7.0, mx.DAQmx_Val_Rising,
    ...
    def threaded_update(self):
        self.settings['temp0'] = self.read_single()
